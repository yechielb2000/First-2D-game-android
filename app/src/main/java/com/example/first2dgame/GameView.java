...
public class GameView extends SurfaceView implements Runnable {
    ...
    private final int screenX, screenY,sound;
    private int score = 0;
    ...
    public GameView(GameActivity activity, int screenX, int screenY) {
        ...
        random = new Random();
        sharedPreferences = activity.getSharedPreferences("2D game", Context.MODE_PRIVATE);
    ...
    private void update() {
        ...
        if (flight.isGoingUp) flight.y -= 30 * screenRatioY;
        ...
        for (Bullet bullet: bullets) {
            ...
            for (Bird bird: birds) {
                if(Rect.intersects(bullet.getCollisionShape(), bird.getCollisionShape())){
